...
void wireless_devs_change_kb(uint8_t old_devs, uint8_t new_devs, bool reset) {
    ...
    switch (new_devs) {
        case DEVS_BT1: {
            if (reset) {
                rgb_matrix_wls_indicator_set(66, (RGB){RGB_BLUE}, 200, 1);
            } else {
                rgb_matrix_wls_indicator_set(66, (RGB){RGB_BLUE}, 500, 1);
            }
        } break;
        case DEVS_BT2: {
            if (reset) {
        ...
        case DEVS_2G4: {
            if (reset) {
                rgb_matrix_wls_indicator_set(63, (RGB){RGB_RED}, 200, 1);
            } else {
                rgb_matrix_wls_indicator_set(63, (RGB){RGB_RED}, 500, 1);
            }
        } break;
        default:
            break;
...
bool rgb_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    ...
    if (host_keyboard_led_state().caps_lock) {      
        rgb_matrix_set_color(37, 0x77, 0x77, 0x77);
    }
